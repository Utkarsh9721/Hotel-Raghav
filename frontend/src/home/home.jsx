                ...
                <div className="container">
                    ...
                    <div className="gallery-grid">
                        <div className="gallery-item">
                            ...
                            <div className="gallery-overlay"><span>Hotel Exterior</span></div>
                        </div>
                        <div className="gallery-item">
                            <img src={RoomInterior} alt="Room Interior" className="gallery-img" />
                            <div className="gallery-overlay"><span>Room Interior</span></div>
                        </div>
                        <div className="gallery-item">
                            <img src={Restaurant} alt="Restaurant" className="gallery-img" />
                            <div className="gallery-overlay"><span>Restaurant</span></div>
                        </div>
                        <div className="gallery-item">
                            <img src={Lobby} alt="Lobby" className="gallery-img" />
                            <div className="gallery-overlay"><span>Lobby</span></div>
                        </div>
                        <div className="gallery-item">
                            <img src={EventHall} alt="Event Hall" className="gallery-img" />
                            <div className="gallery-overlay"><span>Event Hall</span></div>
                        </div>
                        <div className="gallery-item">
                            <img src={GardenArea} alt="Garden Area" className="gallery-img" />
                            <div className="gallery-overlay"><span>Garden Area</span></div>
                        </div>
                    </div>
                </div>
            </section>
